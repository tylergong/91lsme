<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-07-26 17:34:45
         compiled from "app/web/templates/newlayout/html/home.shtml" */ ?>
<?php /*%%SmartyHeaderCode:154326033259674f15902977-62430133%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '353303273061a59adea37119b7e53e8720fc111c' => 
    array (
      0 => 'app/web/templates/newlayout/html/home.shtml',
      1 => 1501061675,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '154326033259674f15902977-62430133',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_59674f15911a79_79045409',
  'variables' => 
  array (
    'hot_lists' => 0,
    'hot' => 0,
...
<?php if ($_valid && !is_callable('content_59674f15911a79_79045409')) {function content_59674f15911a79_79045409($_smarty_tpl) {?><div class="met-banner" style="height: 50px;">
        ...
        <!--<div class="carousel-inner " role="listbox">-->
            ...
            <!--<div class="item active">-->
                <!--<a href="#" title="" target='_self'>-->
                    <!--<picture>-->
                        <!--<source srcset="<?php echo $_smarty_tpl->getConfigVariable('cdn_url');?>
/app/web/templates/newlayout/image/1480040551.jpg"-->
                                <!--media="(min-width: 768px)"/>-->
                        <!--<img class="cover-image overlay-scale"-->
                             <!--srcset="<?php echo $_smarty_tpl->getConfigVariable('cdn_url');?>
/app/web/templates/newlayout/image/1480040551-s.jpg"-->
                             <!--alt=""/>-->
                    <!--</picture>-->
            ...
            <!--<div class="item ">-->
                <!--<a href="#" title="" target='_self'>-->
                    <!--<picture>-->
                        <!--<source srcset="<?php echo $_smarty_tpl->getConfigVariable('cdn_url');?>
/app/web/templates/newlayout/image/1479979962.jpg"-->
                                <!--media="(min-width: 768px)"/>-->
                        <!--<img class="cover-image overlay-scale"-->
                             <!--srcset="<?php echo $_smarty_tpl->getConfigVariable('cdn_url');?>
/app/web/templates/newlayout/image/1479979962-s.jpg"-->
                             <!--alt=""/>-->
                    <!--</picture>-->
        ...
        <div class="row">
            ...
            <ul class="blocks blocks-100 blocks-xlg-4 blocks-md-4 blocks-sm-2 no-space" data-plugin="matchHeight"
                ...
                <li class="invisible animation-delay-800" data-plugin="appear" data-animate="slide-bottom"
                    data-repeat="false">
                    <a href="/articlelist/4" title="生活随笔">
...
" target='_blank'>
                            <img class="overlay-figure"
                                 data-original="<?php echo $_smarty_tpl->getConfigVariable('cdn_url');?>
/app/web/templates/newlayout/image/1479711841486775-s.jpeg"
                                 src="<?php echo $_smarty_tpl->getConfigVariable('cdn_url');?>
/app/web/templates/newlayout/image/1479711841486775-s.jpeg"
                                 alt="<?php echo $_smarty_tpl->tpl_vars['hot']->value['title'];?>
">
                            <figcaption
                                    class="overlay-bottom overlay-panel overlay-background overlay-slide-top">
                                <h4><?php echo $_smarty_tpl->tpl_vars['hot']->value['title'];?>
</h4>
                            </figcaption>
                        </a>
                    </figure>
                    <p class="des"><?php echo $_smarty_tpl->tpl_vars['hot']->value['title'];?>
</p>
                </div>
            </li>
            <!-- <?php } ?> -->
