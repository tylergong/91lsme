...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_59678d05688e06_84054385',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59678d05688e06_84054385')) {function content_59678d05688e06_84054385($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/Users/gm/Documents/www/91lsme/framework/lib/smarty/plugins/modifier.date_format.php';
...
>
	...
	<body>
		<div class="main"> 
			<!-- 顶部 -->
			<div class="top"> <?php echo $_smarty_tpl->getSubTemplate ("app/web/templates/public/html/header.shtml", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array(), 0);?>
 </div>
			<!-- 导航 -->
			<div class="nav"> <?php echo $_smarty_tpl->getSubTemplate ("app/web/templates/public/html/nav.shtml", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array(), 0);?>
 </div>
			<div class="content"> 
				<!-- 左边框 -->
				<div class="left"> <?php echo $_smarty_tpl->getSubTemplate ("app/web/templates/public/html/left.shtml", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array(), 0);?>
 </div>
...
.shtml<?php } else { ?>?id=<?php echo $_smarty_tpl->tpl_vars['updown']->value['down']['id'];
					...
					<div class="cbottom"> <?php echo $_smarty_tpl->getSubTemplate ("app/web/templates/public/html/bottom_ad.shtml", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array(), 0);?>
 </div>
				</div>
			</div>
			<!-- 低部 -->
			<div class="bottom"> <?php echo $_smarty_tpl->getSubTemplate ("app/web/templates/public/html/footer.shtml", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array(), 0);?>
 </div>
		</div>
	</body>
</html><?php }} ?>
